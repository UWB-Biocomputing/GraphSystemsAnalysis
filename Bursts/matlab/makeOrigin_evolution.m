function makeOrigin_evolution()
% MAKEORIGIN_EVOLUTION Assemble the burst origin evolution plot into a 2x2 grid

fig = figure('Name', 'Burst Origin Evolution', 'Position', [100, 100, 1000, 1000]);
clf(fig);
...
for i = 1:4
    ...
    burstOriginMovement(dirs{i,1}, 5, t_inner);
    title(t_inner, dirs{i,2}, 'FontWeight', 'bold', 'FontSize', 14);
end



exportgraphics(t, 'origin-evolution.pdf');
