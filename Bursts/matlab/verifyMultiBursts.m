% VERIFYMULTIBURSTS manual check of multi-burst detection
% Goes through the list of multi-bursts, output diagnostic information and display
...
%
%   Syntax: verifyMultiBursts(h5dir)
%
%   Input:
...
function verifyBurstSpeed(h5dir)
...
% Get list of putative multiple bursts
multiBurstIDs = readmatrix([h5dir '/multipleBursts.csv']);

fprintf('done\n');

for burstNum = multiBurstIDs'
